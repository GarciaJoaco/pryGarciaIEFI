...
{
    public partial class frmModificaruAgregarSocios : Form
    {
        ...
        public frmModificaruAgregarSocios()
        {
            InitializeComponent();
        }

        private void frmModificaruAgregarSocios_Load(object sender, EventArgs e)
        {
        ...
        private void SSEstado_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
